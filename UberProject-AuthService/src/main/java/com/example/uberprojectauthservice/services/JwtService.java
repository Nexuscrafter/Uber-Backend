...
public class JwtService implements CommandLineRunner {
    ...
    public String createToken(Map<String, Object> payload, String email) {
        ...
        return Jwts.builder()
                ...
                .subject(email)
                .signWith(getSignKey()) //secret key
                .compact();
    ...
    public <T> T extractClaim(String token, Function<Claims, T> claimsResolver) {
        final Claims claims = extractAllPayloads(token); //extraction of payload and returning a Claims object
    ...
    //this method checks whether the token expiry is before the current timestamp or not ?
